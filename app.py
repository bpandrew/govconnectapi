...
# *** filter by segment/family/class/commodity here
		...
		for index, row in df.iterrows(): 
			...
			data['bubble_competitors'].append({"id": index[0], "label":[index[1]], "backgroundColor": bg_color, "borderColor": border_color, "data":[{"x": round(row['score'], 4),"y": row['score_overlap'],"r": (row['count']*4)+4 }]})
	else:
		data['competitors'] = []
